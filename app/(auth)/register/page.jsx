    ...
    <div className="flex justify-center items-center h-[100vh] bg-[#002255]">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <button
            type="submit"
            className="duration-300 border font-bold text-gray-900 dark:text-gray-100 dark:border-gray-400 border-gray-900 rounded p-2 mr-2 hover:bg-gradient-to-r from-indigo-700 via-violet-700 to-cyan-950 hover:text-gray-100"
          >
            Register
          </button>
          <Link href="/login" style={{ all: "unset" }}>
            <button className="duration-300 border text-gray-900 dark:text-gray-100 font-bold dark:border-gray-400 border-gray-900 rounded mr-2 p-2 hover:bg-gradient-to-r from-indigo-700 via-violet-700 to-cyan-950  hover:text-gray-100">
              Already a user?
            </button>
          </Link>
        </form>
