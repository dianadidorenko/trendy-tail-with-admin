    ...
    <section className="container mx-auto">
      ...
      <div className="flex flex-col gap-6 lg:gap-12 items-center py-[70px] xs:py-[50px]">
        ...
        >
          ...
          функціональні варіанти одягу для наших пухнастих друзів. У зв'язку з
          зростаючою тенденцією володіння домашніми тваринами та бажанням
          ставитися до наших вихованців як до членів сім'ї, на ринку зростає
          попит на одяг для собак. Наша місія полягає в тому, щоб задовольнити
          цю потребу, пропонуючи широкий асортимент стильного та добре
          продуманого одягу, який не тільки покращує зовнішній вигляд собак, але
          й забезпечує комфорт та захист. зовнішній вигляд собак, але й
          забезпечує комфорт та захист.
        </motion.p>
        <motion.p
        ...
        >
          ...
          веселощів, а й допомагає створити міцніший зв'язок між людьми та їх
          пухнастими друзями. Так що приєднуйтесь до нас у цій захоплюючій
